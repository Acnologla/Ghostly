...
class Scene {
  ...
  loadMap (loader, name) {
    loader
      .add(name + '_sprites', '/public/maps/' + name + '/tiles.png')
      .add(name + '_atlas', '/public/maps/' + name + '/tileset.json')
      .add(name + '_map', '/public/maps/' + name + '/map.json')
      .add(name + '_gates', '/public/maps/' + name + '/gates.json')
  }
